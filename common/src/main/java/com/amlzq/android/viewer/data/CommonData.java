...
public class CommonData {
    ...
    public static final int[] IPPAWARDS = new int[]{
            ...
            R.drawable.ippawards_11_2nd_architecture_sallyann_field,
            R.drawable.ippawards_12_3rd_architecture_shuo_chen,
            R.drawable.ippawards_13_1st_children_neri_rivas,
            R.drawable.ippawards_16_1st_floral_dan_liu,
            R.drawable.ippawards_20_2nd_landscape_erik_burdett,
            R.drawable.ippawards_21_3rd_landscape_leyang_shi,
            R.drawable.ippawards_26_2nd_nature_xiao_lin,
            R.drawable.ippawards_27_3rd_nature_yingya_liu,
    ...
    public static final int[] FLICKRS = new int[]{
            R.drawable.flickr_globalfoto_48888298322_7aa572e5ea_k,
            R.drawable.flickr_rdrcollection_6259499387_b127b03a39_o,
            R.drawable.flickr_steveberardi_15397116582_0b386b423c_b
    };
