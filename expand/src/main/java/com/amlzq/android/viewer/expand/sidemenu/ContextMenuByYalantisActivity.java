...
public class ContextMenuByYalantisActivity extends AppCompatActivity implements OnMenuItemClickListener, OnMenuItemLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_context_menu_by_yalantis);
    ...
    private void initToolbar() {
        ...
        TextView mToolBarTextView = (TextView) findViewById(R.id.tvToolbarTitle);
